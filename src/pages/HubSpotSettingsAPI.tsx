...
export default function HubSpotSettingsAPI() {
  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Configuration API HubSpot</h1>
        <p className="text-muted-foreground mt-2">
          Gérez la clé API et la configuration de l'intégration HubSpot
        </p>
      </div>
