  ...
  return <section id="about" className="py-24 bg-gradient-to-br from-background via-primary/5 to-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-16">
          {/* Abdenacer */}
          <div className="group relative overflow-hidden p-8 rounded-2xl bg-card/80 backdrop-blur-md border-2 border-primary/20 hover:border-secondary transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 animate-fade-in-scale">
            {/* Gradient background */}
          ...
          {/* Naim */}
          <div className="group relative overflow-hidden p-8 rounded-2xl bg-card/80 backdrop-blur-md border-2 border-accent/20 hover:border-secondary transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 animate-fade-in-scale" style={{
          animationDelay: '0.1s'
        }}>
            {/* Gradient background */}
            <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-accent/10 opacity-50 group-hover:opacity-100 transition-opacity" />
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 max-w-6xl mx-auto">
          ...
          icon: Icon,
          color
        }, index) => <div key={key} className="group relative overflow-hidden p-6 rounded-2xl bg-card/60 backdrop-blur-sm border-2 border-border hover:border-secondary transition-all duration-300 hover:shadow-xl hover:-translate-y-0.5 animate-fade-in-scale" style={{
