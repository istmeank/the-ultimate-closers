...
const CallBookingForm = () => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="group relative overflow-hidden bg-card/30 backdrop-blur-sm border border-hairline hover:border-secondary transition-all duration-300 hover:shadow-soft hover:-translate-y-0.5 animate-fade-in-scale rounded-3xl p-6 md:p-10 shadow-raised">
        {/* Gradient background */}
